...
public class MinesweeperGame {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            try {
                ...
                String userActionInput = getUserAcionInputFromUser();
    ...
    private static int getSelectedColIndex(String cellInput) {
        return confertColFrom(cellInput.charAt(0));
    }

    private static String getUserAcionInputFromUser() {
    ...
    private static int confertColFrom(char cellInputCol) {
        switch (cellInputCol) {
            case 'a':
                return 0;
            case 'b':
